    ...
    <div className="bg-gray-50 dark:bg-black min-h-[calc(100vh-64px)] py-12 transition-colors">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-500 text-white mb-4 shadow-lg">
            <Zap className="h-8 w-8" />
          </div>
          <h1 className="text-4xl font-extrabold text-black dark:text-white mb-2">Compress PDF file</h1>
          <p className="text-gray-500 dark:text-gray-400 text-lg">Reduce file size while optimizing for maximal PDF quality.</p>
        </div>
        ...
        {!compressedFileUrl ? (
          <div className="flex flex-col items-center">
            ...
            {files.length > 0 && !isProcessing && (
              <div className="mt-12">
                <Button 
                  size="lg" 
                  className="h-16 px-12 text-xl font-bold rounded-xl shadow-xl hover:scale-105 transition-transform bg-blue-500 hover:bg-blue-600"
          ...
          <div className="max-w-md mx-auto bg-white dark:bg-gray-900 rounded-3xl p-12 text-center shadow-2xl border border-gray-100 dark:border-gray-800">
            ...
            <h2 className="text-2xl font-bold text-black dark:text-white mb-2">PDF has been compressed!</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-8">Your file size has been reduced and is ready for download.</p>
            
            <div className="flex flex-col gap-4">
              <a 
                href={compressedFileUrl} 
                download="compressed.pdf"
                className="flex items-center justify-center gap-2 w-full bg-blue-500 text-white py-4 px-8 rounded-xl font-bold text-lg hover:bg-blue-600 transition-colors shadow-lg"
              >
